...
import { logo_two } from "../imagepath";
          ...
          <div className="container head-border">
                ...
                <li className={`has-submenu ${pathname === "about" || pathname === "blank-page" || pathname === "404-page" ||
                  ...
                  {isSideMenu === "pages" ?
                    ...
                    <ul className="submenu">
                      ...
                      <li className={pathname === "onboardScreen" ? "active" : ""} onClick={Reload2}>
            ...
            <ul className="nav header-navbar-rht">
              <li className={pathname === "register" ? "active" : ""}>
                <Link
                  to="/register"
                  className="reg-btn d-flex align-items-center"
                >
              ...
              <li className={pathname === "login" ? "active" : ""}>
                <Link to="/login" className="log-btn d-flex align-items-center">

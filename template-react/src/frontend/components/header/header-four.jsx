...
import {logo_four,key_01 } from '../imagepath';
...
window.addEventListener('scroll',changeBackground);
    ...
    return (
      <>
      {/* Header */}
      <header className={`header header-four ${navbar? 'sticky': ''} `}  > 
        ...
        <div className="container">
          <div className="navbar-header">
            ...
            <Link to="/" className="navbar-brand logo">
              <img src={logo_four} className="img-fluid" alt="Logo" />
            </Link>
          </div>
          <div className="main-menu-wrapper">
            ...
            <Link to="#0" className={isSideMenu === "home" ? "subdrop" : ""} onClick={()=> toggleSidebar(isSideMenu ==="home" ? "": "home")}  >Home <i className="fas fa-chevron-down" /></Link>
              ...
              pathname === "view-invoice"  ? "active" : ""}`}>
                ...
                <ul className="submenu">
                  ...
                  <li className={pathname === "onboardScreen" ? "active" : "" }onClick={Reload4}>
            ...
            <ul className="nav header-navbar-rht sign-page">
              <li className={pathname === "register" ? "active" : ""}>
                <Link to="/register" className="reg-btn">Sign In
                </Link>
              </li>
              <li><img src={key_01} alt="Logo"/></li>
              <li className={pathname === "login" ? "active" : ""}>
            ...
            <ul className="nav header-navbar-rht text-center">

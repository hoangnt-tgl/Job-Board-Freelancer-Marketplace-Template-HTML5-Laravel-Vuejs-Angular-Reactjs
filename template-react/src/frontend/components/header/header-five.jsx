...
import { logo_five, } from '../imagepath';
...
const HeaderFive = (props) => {
  ...
  return (
    <>
      {/* Header */}
      <header className={`header header-five ${navbar ? 'sticky' : ''} `}  >
          ...
          <div className="container">
            <div className="navbar-header">
              ...
              <Link to="/" className="navbar-brand logo">
                <img src={logo_five} className="img-fluid" alt="Logo" />
              </Link>
            </div>
                ...
                <li className={`has-submenu ${pathname === "about" || pathname === "blank-page" || pathname === "404-page" ||
                  ...
                  {isSideMenu === "pages" ?
                    ...
                    <ul className="submenu">
                      ...
                      <li className={pathname === "onboardScreen" ? "active" : ""} onClick={Reload5}>
            ...
            <ul className="nav header-navbar-rht text-center">
              <li className={pathname === "register" ? "active" : ""}>
                <Link to="/register" className="reg-btn">Register
                </Link>
              </li>
              <li className={pathname === "login" ? "active" : ""}>
              ...
              <li className={pathname === "register" ? "active" : ""}>
                <Link to="/post-project" className="login-btn btn">Post a Project
                </Link>
              </li>
            </ul>

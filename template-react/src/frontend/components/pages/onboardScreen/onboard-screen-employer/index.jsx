...
const OnboardScreenEmployer = (props) => {
    const [TabChangeEmp, setTabChangeEmp] = useState({ status: false, value: "25%" });
                                    ...
                                    <div className="multistep-progress" id="freelance_step">
                                        <div className="first-progress">
                                            ...
                                            <ul id="progressbar" className="progressbar">
                                                ...
                                                <li
                                                    className={TabChangeEmp.status ? "progress-active" : ""}
                                                >
                                                ...
                                                <li
                                                    className={TabChangeEmp1.status ? "progress-active" : ""}
                                                >
                                                ...
                                                <li
                                                    className={TabChangeEmp3.status ? "progress-active" : ""}
                                                >
                          ...
                          <div className="d-flex align-items-center">
                            ...
                            <p>100%</p>
                                    ...
                                    {PageChangeEmp === "Employer-Info" ? (
                                        <EmployerInfo nextTabEmp1={nextTabEmp1} prevTabEmp={prevTabEmp} />
                                    ) : (
                                        ""
                                    )}
                                    {PageChangeEmp === "professionalinfoEmp" ? (
                                        <ProfessionalInfoEmp nextTabEmp2={nextTabEmp2} prevTabEmp2={prevTabEmp2} />
                                    ) : (
                                        ""
                                    )}
                                    ...
                                    {PageChangeEmp === "otherEmp" ? (
                                        <OtherEmp nextTabEmp3={nextTabEmp3} prevTabEmp4={prevTabEmp4} />
                                    ) : (
                                        ""
                                    )}

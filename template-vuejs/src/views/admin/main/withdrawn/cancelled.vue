					...
					<div class="row">
						<div class="col-sm-12">
							<div class="subscribe-employe users-list">
								<ul>
									<li ><router-link to="/admin/withdrawn">History </router-link></li>
									<li><router-link to="/admin/withdrawn-pending">Pending</router-link></li>
									<li class="active"><router-link to="/admin/withdrawn-cancelled">Cancelled</router-link></li>
									<li><router-link to="/admin/withdrawn-completed">Completed</router-link></li>
								</ul>
							</div>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="table-avatar content-user">
														<div>
															<h5 class="text-danger">- 3,165,000 USD </h5>
											...
											<tr>
												...
												<td>
													<div class="table-avatar content-user">
														<div>
															<h5 class="text-danger">- 2,335.006 USD</h5>

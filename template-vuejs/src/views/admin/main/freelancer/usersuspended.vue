						...
						<div class="col-sm-12">
							<div class="subscribe-employe users-list">
								<ul>
									...
									<li class="active"><router-link to="/admin/user-suspended">Suspended</router-link></li>
							...
							<div class="page-header user-active">
								<div class="row align-items-center">
									<div class="col">
										<h3 class="page-title">Suspended Freelancer</h3>
									...
									<table class="table table-center table-hover mb-0 user-tables">
										...
										<tbody>
											<tr>
												...
												<td>01 July 2015</td>
												<td>
													<a href="javascript:void(0);" class="user-suspended">Suspended</a>
												</td>

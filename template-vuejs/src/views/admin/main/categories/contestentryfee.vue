						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item"><router-link to="/admin/fees">Fees</router-link></li>
							...
							<div class="card">
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-center table-hover mb-0 datatable" id="contestentryfee">
											<thead>
												<tr>
													<th>Name</th>
													<th>Value</th>	
...
<script>
	...
	export default {
		 mounted() {
            util.datatable('#contestentryfee')

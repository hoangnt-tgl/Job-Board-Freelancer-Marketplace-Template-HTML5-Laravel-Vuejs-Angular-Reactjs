							...
							<div class="tab-content pt-0">
								<div role="tabpanel" id="tab-4" class="tab-pane fade active show">
									<div class="table-responsive">
										<table class="table table-center table-hover mb-0 datatable" id="projects">
											<thead>
												<tr>
													<th></th>
													<th>Logo</th>
											...
											<tbody>
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<router-link to="/admin/profile"><img class="me-2" src="../../../../assets/admin-img/company/img-1.png" alt="User Image"></router-link>
														</h2>
													</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<router-link to="/admin/profile"><img class="me-2" src="../../../../assets/admin-img/company/img-2.png" alt="User Image"></router-link>
														</h2>
													</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<router-link to="/admin/profile"><img class="me-2" src="../../../../assets/admin-img/company/img-3.png" alt="User Image"></router-link>
														</h2>
													</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<router-link to="/admin/profile"><img class="me-2" src="../../../../assets/admin-img/company/img-4.png" alt="User Image"></router-link>
														</h2>
													</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<router-link to="/admin/profile"><img class="me-2" src="../../../../assets/admin-img/company/img-5.png" alt="User Image"></router-link>
														</h2>
													</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<router-link to="/admin/profile"><img class="me-2" src="../../../../assets/admin-img/company/img-6.png" alt="User Image"></router-link>
														</h2>
													</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<router-link to="/admin/profile"><img class="me-2" src="../../../../assets/admin-img/company/img-7.png" alt="User Image"></router-link>
														</h2>
													</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<router-link to="/admin/profile"><img class="me-2" src="../../../../assets/admin-img/company/img-8.png" alt="User Image"></router-link>
														</h2>
													</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<router-link to="/admin/profile"><img class="me-2" src="../../../../assets/admin-img/company/img-9.png" alt="User Image"></router-link>
														</h2>
													</td>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<router-link to="/admin/profile"><img class="me-2" src="../../../../assets/admin-img/company/img-10.png" alt="User Image"></router-link>
														</h2>
													</td>
										...
										<table class="table table-center table-hover mb-0 datatable">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<router-link to="/admin/profile"><img class="me-2" src="../../../../assets/img/company/img-8.png" alt="User Image"></router-link>
														</h2>
													</td>

							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar avatar-online ava-status me-1">
												<img class="avatar-img rounded-circle" alt="User Image" src="../../../assets/admin-img/profiles/avatar-02.jpg">
											</div>
											<div class="avatar avatar-offline ava-status me-1">
												<img class="avatar-img rounded-circle" alt="User Image" src="../../../assets/admin-img/profiles/avatar-02.jpg">
											</div>
								...
								<div class="col-md-12">
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar me-1">
												<img class="avatar-img rounded" alt="User Image" src="../../../assets/admin-img/profiles/avatar-02.jpg">
											</div>
											<div class="avatar">
												<img class="avatar-img rounded-circle" alt="User Image" src="../../../assets/admin-img/profiles/avatar-02.jpg">
											</div>
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar-group">
												<div class="avatar me-1">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="../../../assets/admin-img/profiles/avatar-02.jpg">
												</div>
												<div class="avatar me-1">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="../../../assets/admin-img/profiles/avatar-03.jpg">
												</div>
												<div class="avatar me-1">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="../../../assets/admin-img/profiles/avatar-04.jpg">
												</div>
												<div class="avatar">
							...
							<div class="row">
								<div class="col-12 col-md-6 col-lg-4 d-flex">
									<div class="card flex-fill">
										<img alt="Card Image" src="../../../assets/admin-img/img-01.jpg" class="card-img-top">
										<div class="card-header">

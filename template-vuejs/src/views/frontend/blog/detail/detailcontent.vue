									...
									<div class="about-author">
										<div class="about-author-img">
											<div class="author-img-wrap">
												<router-link to="/developer-details"><img class="img-fluid" alt="" src="../../../../assets/img/img-02.jpg"></router-link>
											</div>
										</div>
										<div class="author-details">
											<router-link to="/developer-details" class="blog-author-name">Web Designer</router-link>

								...
								<div class="pro-content pt-0">
									<ul class="latest-posts">
										<li>
											...
											<div class="post-info">
												<h4>
													<router-link to="/blog-details">Kofejob - How to get job through online?</router-link>
												</h4>
												<a href="javascript:void(0);" class="posts-date"><i class="far fa-calendar-alt"></i> 2 May 2021</a>
											</div>
										</li>
										<li>
											<div class="post-thumb">
											...
											<div class="post-info">
												<h4>
													<router-link to="/blog-details">People who completed NAND technology got job 90% </router-link>
												</h4>
												<a href="javascript:void(0);" class="posts-date"><i class="far fa-calendar-alt"></i> 3 May 2021</a>
											</div>
										</li>
										<li>
											<div class="post-thumb">
											...
											<div class="post-info">
												<h4>
													<router-link to="/blog-details">There are many variations of passages</router-link>
												</h4>
												<a href="javascript:void(0);" class="posts-date"><i class="far fa-calendar-alt"></i> 4 May 2021</a>
											</div>
										</li>
									</ul>
								</div>

										...
										<div class="card card-table">
											<div class="card-header">
												<div class="row">
													...
													<div class="col-auto">
														<router-link to="/manage-projects" class="btn-right btn btn-sm fund-btn">
															View All 
                                                        </router-link>
													</div>
												</div>
													...
													<table class="table table-hover table-center mb-0">
														...
														<tbody>
															<tr>
																...
																<td>12 July, 2021</td>
																<td>47</td>
																<td class="text-end"><router-link to="/view-project-detail" class="text-success">View</router-link></td>
															</tr>
															<tr>
																<td>
																	<span class="detail-text">I want some customization and installation on wordpress</span>

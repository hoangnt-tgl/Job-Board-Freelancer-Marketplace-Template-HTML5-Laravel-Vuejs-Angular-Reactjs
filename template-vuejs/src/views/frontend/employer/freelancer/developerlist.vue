						...
						<div class="col-md-12 col-12 text-center">
							<div class="breadcrumb-list">
								<nav aria-label="breadcrumb" class="page-breadcrumb">
									<ol class="breadcrumb">
										<li class="breadcrumb-item"><router-link to="/index"><i class="fas fa-home"></i> Home</router-link></li>
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
									 ...
									 <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 d-flex">
										<ul class="list-grid d-flex align-items-center">
											<li><router-link to="/developer"><i class="fas fa-th-large"></i></router-link></li>
											<li><router-link to="/developer-list" class="favour-active"><i class="fas fa-list"></i></router-link></li>
										</ul>
							...
							<div class="list-book-mark book-mark favour-book">
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card list-develop-group" v-for="item in developerlist" :key="item.id">
													...
													<div class="author-details">
														<div class="freelance-info">
															...
															<div class="freelance-tags">
																<a href="javascript:void(0);"><span class="badge badge-pill badge-design">{{item.name3}}</span></a>
...
<script>
    import developerlist from '../../../../assets/json/frontend/employer/developerlist.json'

						...
						<div class="col-md-12 col-12 text-center">
							<div class="breadcrumb-list">
								<nav aria-label="breadcrumb" class="page-breadcrumb">
									<ol class="breadcrumb">
										<li class="breadcrumb-item"><router-link to="/index"><img src="../../../../assets/img/home-icon.svg" alt=""> Home</router-link></li>
			...
			<div class="content">
				<div class="container">
					<div class="row">
                        ...
                        <freelancersidebar></freelancersidebar>
              ...
              <div class="sort-tab develop-list-select">
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
									 ...
									 <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 d-flex">
										<ul class="list-grid d-flex align-items-center">
											<li><router-link to="/developer" class="favour-active"><i class="fas fa-th-large"></i></router-link></li>
											<li><router-link to="/developer-list"><i class="fas fa-list"></i></router-link></li>
										</ul>
							...
							<div class="row">
								<div class="col-md-6 col-lg-6 col-xl-4" v-for="item in developer" :key="item.id">
									<div class="freelance-widget">
										<div class="freelance-content">
											...
											<div class="freelance-info">
												<h3><router-link to="/company-profile">{{item.name}}</router-link></h3>
												...
												<div class="freelance-tags">
													...
													<a href="javascript:void(0);"><span class="badge badge-pill badge-design me-1">{{item.name4}}</span></a>
													<a href="javascript:void(0);"><span class="badge badge-pill badge-design">{{item.name5}}</span></a>
												</div>
												<div class="freelancers-price">{{item.name6}}</div>
											</div>
										</div>
										<div class="cart-hover">
											<router-link to="/company-profile" class="btn-cart" tabindex="-1">{{item.name7}}</router-link>
										</div>
									</div>
								</div>
...
<script>
    import developer from '../../../../assets/json/frontend/employer/developer.json'

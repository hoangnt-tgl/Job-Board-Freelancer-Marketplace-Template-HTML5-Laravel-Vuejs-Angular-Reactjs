							...
							<div class="settings-widget">
								...
								<div class="settings-menu">
									<ul>
										...
										<li class="nav-item">
											<router-link to="/membership-plans" class="nav-link active">
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="table-responsive table-box">
												<table class="table table-center table-hover datatable" id="membershipplans">
...
<script>
	...
	export default {
		 mounted() {
            util.datatable('#membershipplans')
		},
	}
	</script>
<template>
    ...
    <header class="header" v-if="currentPath == 'project-proposals' || currentPath == 'edit-project' || currentPath == 'view-invoice'">
            ...
            <div class="main-menu-wrapper">
                ...
                <ul class="main-nav">
                    ...
                    <li class="has-submenu" :class="patientsMenu ? 'active' : 'notactive'">
                        ...
                        <ul class="submenu">
                            <li class="has-submenu" :class="currentPath == 'developer' || currentPath == 'developer-details' ? 'active' : 'notactive'">
                            ...
                            <li :class="currentPath == 'project-proposals' || currentPath == 'manage-projects' || currentPath == 'cancelled-projects' ? 'active' : 'notactive'"><router-link to="/manage-projects">Projects</router-link></li>
                            ...
                            <li :class="currentPath == 'profile-settings' ? 'active' : 'notactive'"><router-link to="/profile-settings">Settings</router-link></li>
                        </ul>
                    </li>
                    <li class="has-submenu" :class="freelancerMenu ? 'active' : 'notactive'">
                        ...
                        <ul class="submenu">
                            ...
                            <li :class="currentPath == 'developer-details' ? 'active' : 'notactive'"><router-link to="/developer-details">Freelancer Details</router-link></li>
                            <li :class="currentPath == 'freelancer-project-proposals' || currentPath == 'freelancer-files' || currentPath == 'freelancer-milestones' || currentPath == 'freelancer-task' || currentPath == 'freelancer-view-project-detail' ? 'active' : 'notactive'"><router-link to="/freelancer-project-proposals">Projects</router-link></li>
                            ...
                            <li :class="currentPath == 'freelancer-withdraw-money' || currentPath == 'freelancer-payment' ? 'active' : 'notactive'"><router-link to="/freelancer-withdraw-money">Payments</router-link></li>							
            ...
            <ul class="nav header-navbar-rht">	
                <li class="nav-item dropdown account-item">
                    ...
                    <div class="dropdown-menu emp">
                        ...
                        <router-link class="dropdown-item" to="/user-account-details"><i class="material-icons">verified_user</i> View profile</router-link>
                        <div class="drop-head">Projects Settings</div>	
                        <router-link class="dropdown-item" to="/manage-projects"><i class="material-icons">business_center</i> Projects</router-link>
                        <router-link class="dropdown-item" to="/favourites"><i class="material-icons">local_play</i> Favourites</router-link>
                        <router-link class="dropdown-item" to="/review"><i class="material-icons">pie_chart</i> Reviews</router-link>
                        <div class="drop-head">Account Details</div>
                        <router-link class="dropdown-item" to="/profile-settings"> <i class="material-icons">settings</i> Profile Settings</router-link>
                ...
                <ul class="main-nav">
                    ...
                    <li class="has-submenu" :class="patientsMenu ? 'active' : 'notactive'">
                        ...
                        <ul class="submenu">
                            ...
                            <li :class="currentPath == 'company-profile' ? 'active' : 'notactive'"><router-link to="/company-profile">My Profile</router-link></li>	
                            <li :class="currentPath == 'company-details' ? 'active' : 'notactive'"><router-link to="/company-details">Company Details</router-link></li>	
                            <li :class="currentPath == 'manage-projects' || currentPath == 'cancelled-projects' ? 'active' : 'notactive'"><router-link to="/manage-projects">Projects</router-link></li>
                            <li :class="currentPath == 'favourites' ? 'active' : 'notactive'"><router-link to="/favourites">Favourites</router-link></li>
                            <li :class="currentPath == 'membership-plans' ? 'active' : 'notactive'"><router-link to="/membership-plans">Membership</router-link></li>
                            <li :class="currentPath == 'milestones' || currentPath == 'change-password' ? 'active' : 'notactive'"><router-link to="/milestones">Milestones</router-link></li>
                            <li :class="currentPath == 'chats' ? 'active' : 'notactive'"><router-link to="/chats">Chats</router-link></li>
...
export default {
    ...
    computed: {
       ...
       patientsMenu() {
           return this.$route.name == 'project-proposals' || this.$route.name == 'change-password' || this.$route.name == 'cancelled-projects' || this.$route.name == 'developer' || this.$route.name == 'withdraw-money' || this.$route.name == 'view-project-detail' || this.$route.name == 'transaction-history' || this.$route.name == 'project-tasks' || this.$route.name == 'project-proposals'  || this.$route.name == 'project-payment' || this.$route.name == 'pending-projects' || this.$route.name == 'ongoing-projects' || this.$route.name == 'invited-freelancer' || this.$route.name == 'files' || this.$route.name == 'completed-projects' || this.$route.name == 'cancelled-projects' || this.$route.name == 'developer-details'   || this.$route.name == 'dashboard'        || this.$route.name == 'manage-projects'     || this.$route.name == 'favourites'     || this.$route.name == 'membership-plans'     || this.$route.name == 'milestones'    || this.$route.name == 'chats'    || this.$route.name == 'review'    || this.$route.name == 'deposit-funds'    || this.$route.name == 'verify-identity'    || this.$route.name == 'profile-settings';
       },
       freelancerMenu() {
           return this.$route.name == 'freelancer-view-project-detail' || this.$route.name == 'freelancer-task' || this.$route.name == 'freelancer-payment' || this.$route.name == 'freelancer-milestones' || this.$route.name == 'freelancer-files' || this.$route.name == 'project' || this.$route.name == 'freelancer-cancelled-projects' || this.$route.name == 'project-details'   || this.$route.name == 'freelancer-dashboard'        || this.$route.name == 'freelancer-project-proposals'     || this.$route.name == 'freelancer-favourites'     || this.$route.name == 'freelancer-membership'     || this.$route.name == 'freelancer-change-password'     || this.$route.name == 'freelancer-chats'     || this.$route.name == 'freelancer-review'     || this.$route.name == 'freelancer-withdraw-money'     || this.$route.name == 'freelancer-verify-identity'    || this.$route.name == 'freelancer-profile-settings';
       },
       pagesMenu() {
           return this.$route.name == 'view-invoice' || this.$route.name == 'about' || this.$route.name == 'blank-page'    || this.$route.name == '404-page'   || this.$route.name == 'user-account-details'        || this.$route.name == 'login'     || this.$route.name == 'register'     || this.$route.name == 'forgot-password';
       },
       BlogMenu() {

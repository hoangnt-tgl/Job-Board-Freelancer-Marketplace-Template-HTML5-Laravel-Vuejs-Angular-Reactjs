							...
							<div class="settings-widget">
								...
								<div class="settings-menu">
									<ul>
										...
										<li class="nav-item">
											<router-link to="/deposit-funds" class="nav-link active">
								...
								<div class="col-md-12">							
									<nav class="user-tabs mb-4">
										<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
											<li class="nav-item">
												<router-link class="nav-link" to="/deposit-funds">Deposit Funds</router-link>
											</li>
											<li class="nav-item">
												<router-link class="nav-link active" to="/withdraw-money">Withdraw Money</router-link>
											</li>
											<li class="nav-item">
												<router-link class="nav-link" to="/transaction-history">Transaction History</router-link>
											</li>
										</ul>
									</nav>
								</div>

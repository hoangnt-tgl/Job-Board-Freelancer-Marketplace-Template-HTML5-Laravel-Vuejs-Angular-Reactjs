...
<div class="review-content no-padding">		
											...
											<div class="review-top tab-reviews d-flex align-items-center">
												<div class="review-img">
													<router-link to="/company-profile"><img class="img-fluid" src="../../../../assets/img/review/review-1.jpg" alt="Post Image"></router-link>
												</div>
												<div class="review-info">
													<h3><router-link to="/company-profile">adirajulk</router-link></h3>
													<h5>Aug 3 • 6:57 AM</h5>	
												</div>					
												<div class="rating">
										...
										<div class="review-content no-padding">		
											...
											<div class="review-top tab-reviews d-flex align-items-center">
												...
												<div class="review-info">
													<h3><router-link to="/company-profile">james</router-link></h3>
													<h5>Aug 2 • 7:57 AM</h5>	
												</div>					
												<div class="rating">
													<i class="fas fa-star filled"></i>

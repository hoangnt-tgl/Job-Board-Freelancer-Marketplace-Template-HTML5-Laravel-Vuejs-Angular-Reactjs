<template>
    <div class="review-content no-padding">		
        ...
        <div class="review-top tab-reviews d-flex align-items-center">
            <div class="review-img">
                <router-link to="/company-profile"><img class="img-fluid" src="../../../../assets/img/review/review-01.jpg" alt="Post Image"></router-link>
            </div>
            <div class="review-info">
                <h3><router-link to="/company-profile">javiervalino</router-link></h3>
    ...
    <div class="review-content no-padding">		
        ...
        <div class="review-top tab-reviews d-flex align-items-center">
            <div class="review-img">
                <router-link to="/company-profile"><img class="img-fluid" src="../../../../assets/img/review/review-02.jpg" alt="Post Image"></router-link>
            </div>
            <div class="review-info">
                <h3><router-link to="/company-profile">trentburns</router-link></h3>

...
<div>
       <!-- Main Wrapper -->
        <div class="main-wrapper">
			...
			<!-- Page Content -->
			<div class="content" style="transform: none !important;min-height: 220.7px !important;">
				<div class="container">	
					<div class="row">	
						<div class="col-md-12">	
											...
											<div class="profile-info profile-edit-form">
												...
												<div class="pro-text3">
													...
													<ul class="profile-preword">
														...
														<li><div class="rating mapgridrating1">							
																...
																<div class="form-row">
																	...
																	<div class="form-group col-lg-4">
																		...
																		<div class=" submit-profile-sec">
																			<a href="javascript:void(0);" class="btn btn-primary profile-update-btn">Update</a>
					...
					<div class="row">
													...
													<li>
														<div class="dropdown profile-action">
															...
															<div class="dropdown-menu dropdown-menu-right">
																<a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#"><i class="fas fa-pencil-alt me-1"></i> Edit</a>
																<a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#"><i class="far fa-trash-alt me-1"></i> Delete</a>
															</div>
														</div>
							...
							<div role="tabpanel" id="feedbacks" class="tab-pane fade">
								<div class="pro-post project-widget widget-box">
									...
									<div class="about-author">
										<div class="about-author-img">
											<div class="author-img-wrap">
												<router-link to="/review"><img class="img-fluid" alt="" src="../../../assets/img/img-01.png"></router-link>
											</div>
										</div>
										<div class="author-details">
											<router-link to="/review" class="blog-author-name">Logo Designer</router-link>
									...
									<div class="about-author">
										<div class="about-author-img">
											<div class="author-img-wrap">
												<router-link to="/review"><img class="img-fluid" alt="" src="../../../assets/img/img-02.jpg"></router-link>
											</div>
										</div>
										<div class="author-details">
											<router-link to="/review" class="blog-author-name">Logo Designer</router-link>
									...
									<div class="about-author">
										<div class="about-author-img">
											<div class="author-img-wrap">
												<router-link to="/review"><img class="img-fluid" alt="" src="../../../assets/img/img-03.jpg"></router-link>
											</div>
										</div>
										<div class="author-details">
											<a href="javascript:void(0);" class="blog-author-name">Logo Designer</a>
							...
							<div role="tabpanel" id="payments" class="tab-pane fade">
								<div class="pro-post project-widget">
									...
									<div class="transaction">
										...
										<a href="javascript:void(0);" class="btn-primary click-btn">Click Here </a>
									</div>
								</div>
								<div class="card">
						...
						<div class="col-lg-4 col-md-12 sidebar-right theiaStickySidebar">	
							...
							<div class="pro-post">	
								<div class="follow-widget">
									<div class="text-end custom-edit-btn">												
										<router-link to="/freelancer-profile-settings" class="sub-title"><i class="fa fa-pencil-alt me-1"></i></router-link>
									</div>
							...
							<div class="pro-post widget-box post-widget">
								...
								<div class="pro-content">
									<a href="javascript:void(0);" class="share-icon"><i class="fas fa-share-alt"></i> Share</a>
								</div>
							</div>
							<!-- /Share Widget -->				
						</div>

							...
							<div class="card list-widget">
								...
								<div class="card-body">
									<ul class="list-group list-group-flush">
										<li class="list-group-item"><a href="javascript:void(0);">1. Using our services</a>
											<ul>
												<li><a href="javascript:void(0);">A. Personal Data that we collect about you</a></li>
												<li><a href="javascript:void(0);">B. Information that we collect automatically on our Sites</a></li>
											</ul>
										</li>
										<li class="list-group-item"><a href="javascript:void(0);">2. Privacy and copyright protection</a></li>
										<li class="list-group-item"><a href="javascript:void(0);">3. Your content in our services</a></li>
									</ul>
								</div>
							</div>
						</div>

        ...
        <div class="main-wrapper">
			...
			<div class="content">
				<div class="container">	
					...
					<div class="row">
						<div class="col-12">
							<router-link to="/project-details" class="btn btn-primary bck-btn mb-4"><i class="fas fa-long-arrow-alt-left me-2"></i> Back to Project </router-link>
						</div>
						<div class="col-12">
								...
								<div class="proposal-cards">
										...
										<div class="row align-items-center">
											<div class="col-lg-2">
												<div class="author-img-wrap">
													<a href="javascript:void(0);"><img class="img-fluid" alt="" src="../../../assets/img/user/avatar-1.jpg"></a>
												</div>
											</div>
											<div class="col-lg-8">
												<div class="author-detail">
													<h4><a href="javascript:void(0);">George Wells</a> <img src="../../../assets/img/flags/de.png" height="16" alt="Lang"></h4>
									...
									<div class="bids-card">
										<div class="row align-items-center">
											<div class="col-lg-2">
												<div class="author-img-wrap">
													<a href="javascript:void(0);"><img class="img-fluid" alt="" src="../../../assets/img/user/avatar-2.jpg"></a>
												</div>
											</div>
											<div class="col-lg-8">
												<div class="author-detail">
													<h4><a href="javascript:void(0);">Timothy Smith</a> <img src="../../../assets/img/flags/fr.png" height="16" alt="Lang"></h4>
													<div class="rating mapgridrating1">							
									...
									<div class="bids-card">
										<div class="row align-items-center">
											<div class="col-lg-2">
												<div class="author-img-wrap">
													<a href="javascript:void(0);"><img class="img-fluid" alt="" src="../../../assets/img/user/avatar-3.jpg"></a>
												</div>
											</div>
											<div class="col-lg-8">
												<div class="author-detail">
													<h4><a href="javascript:void(0);">Janet Paden</a> <img src="../../../assets/img/flags/us.png" height="16" alt="Lang"></h4>
													<div class="rating mapgridrating1">							
									...
									<div class="bids-card">
										<div class="row align-items-center">
											<div class="col-lg-2">
												<div class="author-img-wrap">
													<a href="javascript:void(0);"><img class="img-fluid" alt="" src="../../../assets/img/user/avatar-4.jpg"></a>
												</div>
											</div>
											<div class="col-lg-8">
												<div class="author-detail">
													<h4><a href="javascript:void(0);">James Douglas</a> <img src="../../../assets/img/flags/es.png" height="16" alt="Lang"></h4>
													<div class="rating mapgridrating1">							
									...
									<div class="bids-card">
										<div class="row align-items-center">
											<div class="col-lg-2">
												<div class="author-img-wrap">
													<a href="javascript:void(0);"><img class="img-fluid" alt="" src="../../../assets/img/user/avatar-5.jpg"></a>
												</div>
											</div>
											<div class="col-lg-8">
												<div class="author-detail">
													<h4><a href="javascript:void(0);">Floyd Lewis</a> <img src="../../../assets/img/flags/de.png" height="16" alt="Lang"></h4>
													<div class="rating mapgridrating1">							

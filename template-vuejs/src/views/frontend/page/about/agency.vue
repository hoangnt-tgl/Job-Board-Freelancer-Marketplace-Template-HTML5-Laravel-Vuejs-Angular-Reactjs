					...
					<div class="row align-items-center black-bg">	
						...
						<div class="col-md-6 agency-box black-bg">
							<div class="agency-content">
								...
								<router-link to="/project" class="btn learn-btn">LEARN MORE</router-link>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 mx-auto">
							...
							<div class="btn-item">
								<router-link class="btn get-btn" to="/login">Get Started</router-link>
								<router-link class="btn courses-btn" to="/project">ViEW SERVICES</router-link>
							</div>
						</div>
					</div>
				</div>

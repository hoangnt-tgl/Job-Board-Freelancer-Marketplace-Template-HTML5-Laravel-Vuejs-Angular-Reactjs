							...
							<div class="settings-widget">
								...
								<div class="settings-menu">
									<ul>
										...
										<li class="nav-item">
											<router-link to="/freelancer-membership" class="nav-link active">
							...
							<div class="row">
								<div class="col-lg-4">
									<div class="package-detail">
										...
										<a href="javascript:void(0);" class="btn btn-primary price-btn btn-block">Select Plan</a>
									</div>
								</div>
										...
										<div class="project-table">
											<div class="card-body">
												...
												<div class="table-responsive table-box">
													<table class="table table-center table-hover datatable" id="freelancermembership">
														...
														<tbody>
															<tr>
																...
																<td>
																	...
																	<a href="javascript:void(0);" class="read-text">Invoice : IVIP12023598</a>
																</td>
...
<script>
	...
	export default {
		 mounted() {
            util.datatable('#freelancermembership')
		},
        computed: {
            currentPath() {
